...
{
    class LinePlotAAWidthDotted : TestScene
    {
        public LinePlotAAWidthDotted() : base(
            TestCategory.RA_AntialiasedLines,
            "Anti-Aliased Dotted Lines Drawing",
            @"[TestCase]:
...
Check if lines edges are correctly anti-aliased(blured).")
        ...
        public override Scene GetScene()
        {
            ...
            scene.Camera.Add(new LinePlot(tag: "myPlot", positions: linearray, lineStyle: DashStyle.Dotted)
            {
