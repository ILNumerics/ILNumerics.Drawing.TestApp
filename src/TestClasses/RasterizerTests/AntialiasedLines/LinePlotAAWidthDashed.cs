...
{
    class LinePlotAAWidthDashed : TestScene
    {
        public LinePlotAAWidthDashed() : base(
            TestCategory.RA_AntialiasedLines,
            "Anti-Aliased Dashed Lines Drawing",
            @"[TestCase]:
...
Check if lines edges are correctly anti-aliased(blured).")
        ...
        public override Scene GetScene()
        {
            ...
            scene.Camera.Add(new LinePlot(tag: "myPlot", positions: linearray, lineStyle: DashStyle.Dashed)
            {
