...
{
    class LinePlotAAWidthPlotCube : TestScene
    {
        public LinePlotAAWidthPlotCube() : base(
            TestCategory.RA_AntialiasedLines,
            "Anti-Aliased Solid Lines Drawing in PlotCube",
            @"[TestCase]:
...
Check if lines edges are correctly anti-aliased(blured).")
        ...
        public override Scene GetScene()
        {
            ...
            {
                new LinePlot(tag: "myPlot", positions: linearray, lineStyle: DashStyle.Solid)
                {
