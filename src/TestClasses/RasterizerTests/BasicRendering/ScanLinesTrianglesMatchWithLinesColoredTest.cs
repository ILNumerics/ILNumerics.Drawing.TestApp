...
{
    class ScanLinesTrianglesMatchWithLinesColoredTest : TestScene
    {
        public ScanLinesTrianglesMatchWithLinesColoredTest() : base(
            TestCategory.RA_BasicRendering,
            "ScanLinesTrianglesMatchWithLinesColoredTest",
...
The lines run exactly on the edge, partly sharing pixels with the triangles beneath, according to the Top-left rule for triangles.
