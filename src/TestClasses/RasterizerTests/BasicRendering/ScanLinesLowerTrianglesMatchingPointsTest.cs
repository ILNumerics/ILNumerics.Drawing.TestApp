...
{
    class ScanLinesLowerTrianglesMatchingPointsTest : TestScene
    {

        public ScanLinesLowerTrianglesMatchingPointsTest() : base(
            TestCategory.RA_BasicRendering,
            "ScanLinesLowerTrianglesMatchingPointsTest",
...
Tolerance accepted: 0px! Keep Top-left rasterizing rule in mind! ")
        ...
        public override Scene GetScene()
        {
            ...
            Array<float> A = array(new float[,] { { 0, 0.01f, 0 }, { 0.95f, 0.95f, 1 }, { 0.95f, 0.01f, 0 } }).T;
