...
{
    class ContentFitModeLogarithmicStretchToFill : TestScene
    {
        public ContentFitModeLogarithmicStretchToFill() : base(
            TestCategory.HL_PlotCube,
            "PlotCube's ContentFitModes. Logarithmic Scales, StretchToFill",
            @"[TestCase]:
