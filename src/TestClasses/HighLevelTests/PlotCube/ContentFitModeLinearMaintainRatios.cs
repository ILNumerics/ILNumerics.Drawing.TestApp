...
{
    class ContentFitModeLinearMaintainRatios : TestScene
    {
        public ContentFitModeLinearMaintainRatios() : base(
            TestCategory.HL_PlotCube,
            "PlotCube's ContentFitModes. Linear Scales, MaintainRatios",
            @"[TestCase]:
...
")
        ...
        public override Scene GetScene()
        {
            ...
            scene.First<PlotCube>().ScaleModes.XAxisScale = AxisScale.Linear;
            scene.First<PlotCube>().ScaleModes.YAxisScale = AxisScale.Linear;
