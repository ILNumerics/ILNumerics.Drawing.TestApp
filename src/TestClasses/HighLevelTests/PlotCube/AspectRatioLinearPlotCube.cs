...
{
    class AspectRatioLinearPlotCube : TestScene
    {
        public AspectRatioLinearPlotCube() : base(
            TestCategory.HL_PlotCube,
            "PlotCube's AspectRatio Modes, Linear Scales, ContentFitMode:UnitCube",
            @"[TestCase]:
...
")
        ...
        public override Scene GetScene()
        {
            ...
            scene.MouseClick += (object sender, ILNumerics.Drawing.MouseEventArgs e) => {
                if (e.DirectionUp) {
